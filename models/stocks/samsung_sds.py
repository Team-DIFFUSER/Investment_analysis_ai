...
class SamsungSDSModel(BaseStockModel):
    def __init__(self):
        """삼성에스디에스 주가 예측 모델 초기화"""
        super().__init__('삼성에스디에스', '018260.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A018260')  # 삼성에스디에스 종목코드
