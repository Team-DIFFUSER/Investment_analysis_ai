...
class HDHyundaiElectricModel(BaseStockModel):
    def __init__(self):
        """HD현대일렉트릭 주가 예측 모델 초기화"""
        super().__init__('HD현대일렉트릭', '267260.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A267260')  # HD현대일렉트릭 종목코드
