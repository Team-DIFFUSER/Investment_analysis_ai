...
class SamsungFireMarineModel(BaseStockModel):
    def __init__(self):
        """삼성화재 주가 예측 모델 초기화"""
        super().__init__('삼성화재', '000810.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A000810')  # 삼성화재 종목코드
