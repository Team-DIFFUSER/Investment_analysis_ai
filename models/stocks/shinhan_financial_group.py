...
class ShinhanFinancialGroupModel(BaseStockModel):
    def __init__(self):
        """신한지주 주가 예측 모델 초기화"""
        super().__init__('신한지주', '055550.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A055550')  # 신한지주 종목코드
...
if __name__ == "__main__":
    model = ShinhanFinancialGroupModel()
    model.train_model()