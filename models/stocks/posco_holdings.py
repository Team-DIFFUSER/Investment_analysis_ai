...
class PoscoHoldingsModel(BaseStockModel):
    def __init__(self):
        """POSCO홀딩스 주가 예측 모델 초기화"""
        super().__init__('POSCO홀딩스', '005490.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A005490')  # POSCO홀딩스 종목코드
