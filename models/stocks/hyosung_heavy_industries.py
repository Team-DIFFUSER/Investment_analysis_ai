...
class HyosungHeavyIndustriesModel(BaseStockModel):
    def __init__(self):
        """효성중공업 주가 예측 모델 초기화"""
        super().__init__('효성중공업', '298040.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A298040')  # 효성중공업 종목코드
...
if __name__ == "__main__":
    model = HyosungHeavyIndustriesModel()
    model.train_model()