...
class SamsungLifeInsuranceModel(BaseStockModel):
    def __init__(self):
        """삼성생명 주가 예측 모델 초기화"""
        super().__init__('삼성생명', '032830.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A032830')  # 삼성생명 종목코드
...
if __name__ == "__main__":
    model = HDKoreaShipbuildingOffshoreModel()
    model.train_model()