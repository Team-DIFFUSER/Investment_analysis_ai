...
class SamsungElectroMechanicsModel(BaseStockModel):
    def __init__(self):
        """삼성전기 주가 예측 모델 초기화"""
        super().__init__('삼성전기', '009150.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A009150')  # 삼성전기 종목코드
...
if __name__ == "__main__":
    model = SamsungElectroMechanicsModel()
    model.train_model()