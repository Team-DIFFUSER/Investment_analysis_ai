...
class MeritzFinancialGroupModel(BaseStockModel):
    def __init__(self):
        """메리츠금융지주 주가 예측 모델 초기화"""
        super().__init__('메리츠금융지주', '138040.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A138040')  # 메리츠금융지주 종목코드
...
if __name__ == "__main__":
    model = MeritzFinancialGroupModel()
    model.train_model()