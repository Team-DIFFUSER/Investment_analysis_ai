...
class SamsungElectronicsModel(BaseStockModel):
    def __init__(self):
        """삼성전자 주가 예측 모델 초기화"""
        super().__init__('삼성전자', '005930.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A005930')  # 삼성전자 종목코드
