...
class WooriFinancialGroupModel(BaseStockModel):
    def __init__(self):
        """우리금융지주 주가 예측 모델 초기화"""
        super().__init__('우리금융지주', '316140.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A316140')  # 우리금융지주 종목코드
...
if __name__ == "__main__":
    model = WooriFinancialGroupModel()
    model.train_model()
