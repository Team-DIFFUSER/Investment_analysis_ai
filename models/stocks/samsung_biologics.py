...
class SamsungBiologicsModel(BaseStockModel):
    def __init__(self):
        """삼성바이오로직스 주가 예측 모델 초기화"""
        super().__init__('삼성바이오로직스', '207940.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A207940')  # 삼성바이오로직스 종목코드
