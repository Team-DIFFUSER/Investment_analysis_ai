...
class KoreaElectricPowerModel(BaseStockModel):
    def __init__(self):
        """한국전력 주가 예측 모델 초기화"""
        super().__init__('한국전력', '015760.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A015760')  # 한국전력 종목코드
