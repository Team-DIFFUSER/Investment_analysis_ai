...
class HanaFinancialGroupModel(BaseStockModel):
    def __init__(self):
        """하나금융지주 주가 예측 모델 초기화"""
        super().__init__('하나금융지주', '086790.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A086790')  # 하나금융지주 종목코드
