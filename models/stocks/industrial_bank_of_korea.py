...
class IndustrialBankOfKoreaModel(BaseStockModel):
    def __init__(self):
        """기업은행 주가 예측 모델 초기화"""
        super().__init__('기업은행', '024110.KS')
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            data = self.db_manager.get_stock_data('A024110')  # 기업은행 종목코드
...
if __name__ == "__main__":
    model = IndustrialBankOfKoreaModel()
    model.train_model()